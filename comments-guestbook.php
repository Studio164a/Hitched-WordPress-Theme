<?php
?>
	<div class="comments_section guestbook">
	...
	<?php if ( have_comments() ) : ?>		
		...
		<ol class="comments_list">
			<?php
				 ...
				 */
				wp_list_comments( array( 'callback' => 'osfa_comment_guestbook' ) );
			?>
		</ol>
	...
	<?php comment_form( array( 
		...
		'title_reply' => sprintf( '<i class="icon-comment"></i> %s', __( 'Leave a message', 'hitched' ) ), 
